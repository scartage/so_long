...
/*   Updated: 2022/10/26 21:20:37 by scartage         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	vars->imgs[3].img_ptr = mlx_xpm_file_to_image(vars->mlx, "imagenes/img_for_final/morty_face_w.xpm", &width, &height);
	vars->imgs[3].data = mlx_get_data_addr(vars->imgs[3].img_ptr, &vars->imgs[3].bpp, &vars->imgs[3].size, &vars->imgs[3].endian);

	vars->imgs[5].img_ptr = mlx_xpm_file_to_image(vars->mlx, "imagenes/img_for_final/morty_face_s.xpm", &width, &height);
	vars->imgs[5].data = mlx_get_data_addr(vars->imgs[5].img_ptr, &vars->imgs[5].bpp, &vars->imgs[5].size, &vars->imgs[5].endian);
	
	vars->imgs[6].img_ptr = mlx_xpm_file_to_image(vars->mlx, "imagenes/img_for_final/morty_face_a.xpm", &width, &height);
	vars->imgs[6].data = mlx_get_data_addr(vars->imgs[6].img_ptr, &vars->imgs[6].bpp, &vars->imgs[6].size, &vars->imgs[6].endian);
	
	vars->imgs[7].img_ptr = mlx_xpm_file_to_image(vars->mlx, "imagenes/img_for_final/morty_face_d.xpm", &width, &height);
...
void	reading_imgs(t_vars *vars)
{
	...
	vars->imgs[1].img_ptr = mlx_xpm_file_to_image(vars->mlx, "imagenes/img_for_final/espacio.xpm", &width, &height);
	vars->imgs[1].data = mlx_get_data_addr(vars->imgs[1].img_ptr, &vars->imgs[1].bpp, &vars->imgs[1].size, &vars->imgs[1].endian);
	
	vars->imgs[2].img_ptr = mlx_xpm_file_to_image(vars->mlx, "imagenes/img_for_final/mega_semilla.xpm", &width, &height);
	vars->imgs[2].data = mlx_get_data_addr(vars->imgs[2].img_ptr, &vars->imgs[2].bpp, &vars->imgs[2].size, &vars->imgs[2].endian);

	vars->imgs[4].img_ptr = mlx_xpm_file_to_image(vars->mlx, "imagenes/img_for_final/exit.xpm", &width, &height);
